...
SHO_PUBLIC void get_terminal_density_from_file(const char *DENSITYFILE, const char *CFILE);
...
SHO_PUBLIC void set_volume_fromrv(const char *UNITFILE);
SHO_PUBLIC void set_constriction_from_file(const char *CNSTCTFILE);
